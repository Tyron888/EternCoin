Contributing to Etern Core
============================

The Etern Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Etern Core project, and is not to be
confused with overall Etern Network Protocol consensus changes.

Whether a pull request is merged into Etern Core rests with the project merge
...
Patches that change Etern consensus rules are considerably more involved than
...
Where a patch set proposes to change the Etern consensus, it must have been
...
The project leader is the release manager for each Etern Core release.
