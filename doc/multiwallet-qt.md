...
In order to support loading of multiple wallets in etern-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is etern.cpp.
...
Changes to etern.cpp
----------------------
etern.cpp is the entry point into etern-qt, and as such, will require some minor modifications to provide hooks for
