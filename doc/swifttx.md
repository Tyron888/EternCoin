...
This mechanism has been integrated into Bitcore-Node-Etern which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Etern-Project/insight-api-etern#web-socket-api](https://github.com/Etern-Project/insight-api-etern#web-socket-api) 
* API: [https://github.com/Etern-Project/insight-api-etern#swifttx-transactions](https://github.com/Etern-Project/insight-api-etern#swifttx-transactions) 
...
By default, the Etern Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Etern Core daemon:
