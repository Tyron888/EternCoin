                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Etern Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Etern address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and etern: URIs)"));
...
/*
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zETEN"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Etern Core"), this);
    aboutAction->setStatusTip(tr("Show information about Etern Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Etern"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Etern addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Etern addresses"));
    ...
    openAction->setStatusTip(tr("Open a Etern: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Etern Core help message to get a list with possible Etern command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Etern Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Etern network", "", count));
}
...
{
    QString strTitle = tr("Etern Core"); // default title
