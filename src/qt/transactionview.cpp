 ...
 */
    ...
    typeWidget->addItem(tr("Received Eten from zEten"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zEten"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEten));
