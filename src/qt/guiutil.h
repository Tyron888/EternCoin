...
/** Utility functions used by the Etern Qt UI.
 */
namespace GUIUtil
{
...
// Render Etern addresses in monospace font
...
// Parse "etern:" URI into recipient object, return true on successful parsing
