...
/* Etern GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Etern"
#define QAPP_ORG_DOMAIN "etern.tech"
#define QAPP_APP_NAME_DEFAULT "Etern-Qt"
#define QAPP_APP_NAME_TESTNET "Etern-Qt-testnet"
