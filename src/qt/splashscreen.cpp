...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Etern Core");
    ...
    QString copyrightTextEtern = QChar(0xA9) + QString(" 2021 ") + QString(tr("The Etern Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextEtern);
