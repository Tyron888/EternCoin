...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Etern features */
        {"etern", "masternode", &masternode, true, true, false},
        {"etern", "listmasternodes", &listmasternodes, true, true, false},
        {"etern", "getmasternodecount", &getmasternodecount, true, true, false},
        {"etern", "masternodeconnect", &masternodeconnect, true, true, false},
        {"etern", "masternodecurrent", &masternodecurrent, true, true, false},
        {"etern", "masternodedebug", &masternodedebug, true, true, false},
        {"etern", "startmasternode", &startmasternode, true, true, false},
        {"etern", "createmasternodekey", &createmasternodekey, true, true, false},
        {"etern", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"etern", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"etern", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"etern", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"etern", "getmasternodescores", &getmasternodescores, true, true, false},
        {"etern", "mnbudget", &mnbudget, true, true, false},
        {"etern", "preparebudget", &preparebudget, true, true, false},
        {"etern", "submitbudget", &submitbudget, true, true, false},
        {"etern", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"etern", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"etern", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"etern", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"etern", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"etern", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"etern", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"etern", "checkbudgets", &checkbudgets, true, true, false},
        {"etern", "mnsync", &mnsync, true, true, false},
        {"etern", "spork", &spork, true, true, false},
        {"etern", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"etern", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> etern-cli " + methodname + " " + args + "\n";
}
