...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0000089346df3583dfb27ed249d975fd277e90d592a138031f6b6ef07e5d0975"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1625043768, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 27001;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Etern starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 60 * 60; // Etern: 1 hr
        nTargetSpacing = 120;  // Etern: 2 min
        nMaturity = 10;
        nMasternodeCollateral = 10000; // 20,000 ETEN
        ...
        const char* pszTimestamp = "ETERN BLOCKCHAIN DEVELOPERS CORP JUNE 2021";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1625043768;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 3041186;



        hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashMerkleRoot == uint256("0xecef6ca413416f994197009cc8d906cbc743d6ded5a39a4f1c23a9aa9d9889e2"));
        assert(hashGenesisBlock == uint256("0x0000089346df3583dfb27ed249d975fd277e90d592a138031f6b6ef07e5d0975"));

        // Zerocoin, activated never
        nZerocoinStartHeight = INT_MAX;
        nZerocoinStartTime = INT_MAX;

        vSeeds.push_back(CDNSSeedData("0", "139.180.186.231"));             // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("1", "45.76.33.21"));      // Secondary DNS Seeder
        vSeeds.push_back(CDNSSeedData("2", "149.28.67.56"));     // Third DNS Seeder

        // https://en.bitcoin.it/wiki/List_of_address_prefixes
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 33);     // starts with B
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("etern.tech", "testnet-seeds.etern.tech"));             // Primary DNS Seeder
        vSeeds.push_back(CDNSSeedData("gig8.com", "testnet-seeds.etern.gig8.com"));      // Secondary DNS Seeder

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 88); // Testnet etern addresses start with 'b''
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 125);  // Testnet etern script addresses start with 's'
        ...
        // Testnet etern BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 60 * 60; // Etern: 1 hour
        nTargetSpacing = 120;        // Etern: 2 min
