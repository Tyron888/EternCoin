...
RESOURCES += src/qt/etern.qrc src/qt/etern_locale.qrc

TRANSLATIONS += src/qt/locale/etern_bg.ts \
                src/qt/locale/etern_de.ts \
                src/qt/locale/etern_en.ts \
                src/qt/locale/etern_es.ts \
                src/qt/locale/etern_fi.ts \
                src/qt/locale/etern_fr.ts \
                src/qt/locale/etern_it.ts \
                src/qt/locale/etern_ja.ts \
                src/qt/locale/etern_pl.ts \
                src/qt/locale/etern_pt.ts \
                src/qt/locale/etern_ru.ts \
                src/qt/locale/etern_sk.ts \
                src/qt/locale/etern_sv.ts \
                src/qt/locale/etern_vi.ts \
                src/qt/locale/etern_zh_CN.ts \
                src/qt/locale/etern_zh_TW.ts
