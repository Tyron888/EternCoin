...
#   c) node1 mines 32 blocks, so now node 0 has 60001eten, node 1 has 4250eten, node2 has none.
#   d) node0 sends 601 eten to node2, in two transactions (301 eten, then 300 eten).
